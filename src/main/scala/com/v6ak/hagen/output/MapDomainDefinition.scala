...
import com.v6ak.hagen.{Element, TupleElement}

abstract class MapDomainDefinition[T <: Seq[TupleElement]](source: HagenKey[T], val domain: String, reloadService: ServiceId)
